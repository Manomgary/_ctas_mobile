...
import { ACTIVE, EC, IMAGE_DIR, MV, PA, SC, SG, STC, SYNC, UPDATE } from 'src/app/utils/global-variables';
...
export class SuiviBlocPage implements OnInit {
  ...
  // Displayed column
  private displayedColumnsMepSg: string[] = ['annee', 'saison', 'bloc', 'parcelle', 'code_benef', 'nom_benef', 'ddp', 'variette', 'qso', 'dds', 'sfce_embl', 'sc', 'ea'];
  private displayedColumnsAddMepSg: string[] = ['new_annee', 'new_saison', 'new_bloc', 'new_parcelle', 'new_code_benef', 'new_nom_benef', 'new_ddp', 'new_variette', 'new_qso', 'new_dds', 'new_sfce_embl', 'new_sc', 'new_ea', 'new_action'];
  private displayedColumnsSuiviSg: string[] = ['ddp', 'stc', 'long_ligne', 'nbre_ligne', 'img_cult', 'estimation', 'action'];
  private displayedColumnsAddSuiviSg: string[] = ['new_ddp', 'new_stc', 'new_long_ligne', 'new_nbre_ligne', 'new_img_cult', 'new_estimation', 'new_action'];
  private displayedColumnsMepPa: string[] = ['annee', 'saison', 'bloc', 'parcelle', 'code_benef', 'nom_benef', 'ddp', 'espece', 'qo', 'dt_mep', 'sfce_embl'];
  private displayedColumnsAddMepPa: string[] = ['new_annee', 'new_saison', 'new_bloc', 'new_parcelle', 'new_code_benef', 'new_nom_benef', 'new_ddp', 'new_espece', 'new_qo', 'new_dt_mep', 'new_sfce_embl', 'new_action'];
  private displayedColumnsSuiviPa: string[] = ['ddp', 'ql', 'qr', 'action'];
  private displayedColumnsAddSuiviPa: string[] = ['new_ddp', 'new_ql', 'new_qr', 'new_action'];
  private displayedColumnsMepMv: string[] = ['annee', 'saison', 'bloc', 'parcelle', 'code_benef', 'nom_benef', 'ddp', 'espece', 'qso', 'dt_mep', 'sfce_embl', 'sc', 'ea'];
  private displayedColumnsAddMepMv: string[] = ['new_annee', 'new_saison', 'new_bloc', 'new_parcelle', 'new_code_benef', 'new_nom_benef', 'new_ddp', 'new_espece', 'new_qso', 'new_dt_mep', 'new_sfce_embl', 'new_sc', 'new_ea', 'new_action'];
  ...
  private displayedColumnsAllSvSg: string[] = ['code_suivi', 'bloc', 'parcelle', 'code_benef', 'nom', 'variette', 'qso', 'dds', 'sfce_emb', 'sc', 'ddp', 'stc', 'long_ligne', 'nbre_ligne', 'img_cult', 'ex'];
  ...
  private displayedColumnsAllSvPa: string[] = ['code_suivi', 'bloc', 'parcelle', 'code_benef', 'nom', 'ddp', 'espece', 'qso', 'dds', 'sfce_emb', 'ql', 'qr'];
  ...
  onSaveEditSuivi(_data_: any) {
    ...
    switch(_data_.src) {
      case 'sv-sg':
        ...
        update_suivi.stc = val_sg.stc.value;
        update_suivi.ex = val_sg.estimation;
        update_suivi.img_cult = this.fileImgSvSg != null? this.fileImgSvSg.data:data_row.img_cult;
  ...
  **************************/
  ...
  generateCodeMep() {
    ...
    // generer code projet
    let arr_pr: string[] = nom_pr.trim().split(" ");
    arr_pr.forEach((elem, i) => {
      let len = arr_pr.length;
      switch (len) {
        case 1:
      ...
      console.log("Code projet bloc:::", code_pr);
    });
    ...
    modal.onDidDismiss().then((res_modal) => {
      ...
      if ((data_modal.isAddMepSg != undefined && data_modal.isAddMepSg) || (data_modal.isAddMepPa != undefined && data_modal.isAddMepPa) || (data_modal.isAddMepMv != undefined &&  data_modal.isAddMepMv)) {
        ...
        this.update_mep = {
          ...
          id_var: null,
          nom_var: null,
          id_saison: saison.code_saison,
          nom_saison: saison.intitule,
